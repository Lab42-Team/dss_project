    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '/users/<_us:(list|create)>' => 'main/users/<_us>',
                '/users/<_us:(view|update|delete)>/<id:\d+>' => 'main/users/<_us>',
                '/tasks/<_ts:(list|create)>' => 'main/tasks/<_ts>',
                '/tasks/<_ts:(view|update|delete|calculate)>/<id:\d+>' => 'main/tasks/<_ts>',
